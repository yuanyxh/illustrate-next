...
import { isEmpty, createCanvasContext, isBrowser } from '@/_libs';
import bulidColor from '../_libs//bulidColor';
import GIF from '../_libs/GIF';
import Card from '@/_components/Card/Card';
import Button from '@/_components/Button/Button';
import MessageBox from '@/_components/MessageBox/MessageBox';
import Configuration from './Configuration';
import type { BulidColor, ImageOptions } from '../_types';
...
export default function GIFPicture() {
  ...
  useMemo(() => {
    gif.current.on('finished', (blob) => {
      isBrowser() && window.open(window.URL.createObjectURL(blob));
