import { MAX_CODE_SIZE } from '../_config';
import Trie from './Trie';
import GIFByte from './GIFByte';
import bulidColor from './bulidColor';
import type { ImageOptions, ColorObject } from '../_types';
...
function encoder(e: MessageEvent<ImageOptions>) {
  ...
  postMessage({ index: options.index, data: image });

  // console.log('end', self.performance.now());
}

addEventListener('message', encoder);
